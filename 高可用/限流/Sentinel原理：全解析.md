...
![sentinel-project-structure](https://gitee.com/all_4_you/sentinel-tutorial/raw/master/sentinel-principle/sentinel-overall-introduce/images/sentinel-project-structure.png)
...
![sentinel-basic-demo-flow-qps](https://gitee.com/all_4_you/sentinel-tutorial/raw/master/sentinel-principle/sentinel-overall-introduce/images/sentinel-basic-demo-flow-qps.png)
...
![sentinel-basic-demo-flow-qps-result](https://gitee.com/all_4_you/sentinel-tutorial/raw/master/sentinel-principle/sentinel-overall-introduce/images/sentinel-basic-demo-flow-qps-result.png)
...
![sentinel-basic-demo-flow-qps-module](https://gitee.com/all_4_you/sentinel-tutorial/raw/master/sentinel-principle/sentinel-overall-introduce/images/sentinel-basic-demo-flow-qps-module.png)

那为了证明在单线程下限流的正确性与可靠性，那我们的模型就应该变成了这样：

![sentinel-basic-demo-flow-qps-single-thread-module](https://gitee.com/all_4_you/sentinel-tutorial/raw/master/sentinel-principle/sentinel-overall-introduce/images/sentinel-basic-demo-flow-qps-single-thread-module.png)

那接下来我把 `threadCount` 的值改为1，只有一个线程来执行这个方法，看下具体的限流结果，执行上面的代码后打印的结果如下：

![sentinel-basic-demo-single-thread-flow-qps-result](https://gitee.com/all_4_you/sentinel-tutorial/raw/master/sentinel-principle/sentinel-overall-introduce/images/sentinel-basic-demo-single-thread-flow-qps-result.png)
...
![slot-chain-1](https://gitee.com/all_4_you/sentinel-tutorial/raw/master/sentinel-principle/sentinel-overall-introduce/images/slot-chain-1.png)

将第一个节点添加到链表中后，整个链表的结构变成了如下图这样：

![slot-chain-2](https://gitee.com/all_4_you/sentinel-tutorial/raw/master/sentinel-principle/sentinel-overall-introduce/images/slot-chain-2.png)

将所有的节点都加入到链表中后，整个链表的结构变成了如下图所示：

![slot-chain-3](https://gitee.com/all_4_you/sentinel-tutorial/raw/master/sentinel-principle/sentinel-overall-introduce/images/slot-chain-3.png)
...
![slot-chain-entry-process](https://gitee.com/all_4_you/sentinel-tutorial/raw/master/sentinel-principle/sentinel-overall-introduce/images/slot-chain-entry-process.png)
...
![slot-chain-entry-whole-process](https://gitee.com/all_4_you/sentinel-tutorial/raw/master/sentinel-principle/sentinel-overall-introduce/images/slot-chain-entry-whole-process.png)
...
![dashboard-client-transport](https://gitee.com/all_4_you/sentinel-tutorial/raw/master/sentinel-principle/sentinel-overall-introduce/images/dashboard-client-transport.png)
